  ...
  return (
    <header className="relative overflow-hidden pt-8 pb-20 md:pt-14 md:pb-28">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        {/* Luminous Top Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-background/70 px-4 py-1.5 text-xs font-semibold text-primary shadow-sm backdrop-blur-md transition-all hover:border-primary/40">
        ...
        {/* Master Headline */}
        <h1 className="mx-auto mt-6 max-w-4xl text-[36px] font-extrabold leading-[1.12] tracking-[-0.03em] text-foreground sm:text-[54px] md:text-[62px]">
          Kelola sekolah dari satu tempat,{" "}
          <span className="bg-gradient-to-r from-primary via-brand-accent to-[#ea2261] bg-clip-text text-transparent">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className="w-full rounded-full border-border bg-background/80 px-7 py-6 text-[15px] font-medium text-secondary-foreground backdrop-blur-sm transition-all hover:border-primary/40 hover:bg-background hover:text-primary sm:w-auto"
          >
            Masuk ke Akun
          </Button>
        </div>
      ...
      <div className="relative z-10 mx-auto mt-12 max-w-5xl px-4 sm:px-6">
        <div className="rounded-2xl border border-border bg-background p-2.5 shadow-[0_20px_50px_rgba(13,37,61,0.08),0_4px_12px_rgba(13,37,61,0.03)] backdrop-blur-md sm:p-4">
          {/* Tab Navigation Header */}
          <div className="flex flex-wrap items-center justify-between gap-2 border-b border-border pb-3 px-2">
          ...
          <div className="p-3 sm:p-5">
              ...
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                ...
                <div className="rounded-xl border border-border bg-secondary/50 p-4">
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <Badge className="border-none bg-success-chip text-[10px] font-semibold text-success">
                      +4.2% bln ini
                    </Badge>
                  </div>
                  <div className="mt-2 text-2xl font-black text-foreground [font-feature-settings:'tnum'_1]">
                    94.8%
                  </div>
                ...
                <div className="lg:col-span-2 rounded-xl border border-border p-4 bg-background">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div
                        key={idx}
                        className="flex items-center justify-between rounded-lg border border-border/60 bg-background p-2.5 text-xs transition-colors hover:bg-secondary"
                      >
                        <div className="flex items-center gap-2.5">
                          <Avatar className="h-7 w-7 rounded-full bg-brand-tint text-primary text-[11px] font-bold">
                        ...
                        <div className="text-right">
                          <div className="font-bold text-foreground [font-feature-settings:'tnum'_1]">
                            {tx.amount}
                          </div>
                          <Badge
            ...
            {activeTab === "tenant" && (
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between rounded-lg p-2.5 text-left text-xs transition-all ${
                          selectedSchool === school.id
                            ? "border border-primary bg-background font-semibold text-primary shadow-sm"
                            : "border border-transparent bg-background/70 text-secondary-foreground hover:bg-background"
                        }`}
                      >
                        <div>
                          <div>{school.name}</div>
                ...
                <div className="lg:col-span-2 rounded-xl bg-navy p-4 text-white">
              ...
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 rounded-xl border border-[#25d366]/20 bg-[#efeae2] p-4">
                  ...
                  <div className="flex items-center gap-2.5 rounded-t-lg bg-[#075e54] p-3 text-white">
                    <Avatar className="h-8 w-8 rounded-full bg-background text-[#075e54] font-bold text-xs">
