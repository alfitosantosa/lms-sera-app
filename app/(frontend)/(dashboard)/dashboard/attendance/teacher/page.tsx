...
import type { AttendanceStats, AttendanceStatus, CheckinTabProps, StatusConfigMap, TeacherAttendanceRecord } from "@/app/(frontend)/(types)/types/teacher-attendance-types";
