...
import { useGetPaymentByStudentId, usePaymentItemsByStudentId } from "@/app/(frontend)/(hooks)/hooks/Payments/usePaymentItems";
...
function StudentInformation() {
  ...
  const billingItems: PaymentItem[] =
    Array.isArray(rawBilling) ?
      rawBilling.map((item) => ({
        ...item,
